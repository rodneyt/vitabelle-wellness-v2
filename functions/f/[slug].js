...
<head>
    ...
    <title>Not Found - Vita Belle Wellness</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md max-w-md w-full text-center">
        <h1 class="text-2xl font-bold text-red-600 mb-4">404 - Not Found</h1>
        <p class="text-gray-700">The requested form could not be found.</p>
    </div>
</body>
</html>`;
}
...
<body class="bg-gray-50 py-10 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <div class="prose max-w-none mb-8 text-gray-700 bg-gray-50 p-6 rounded-md border border-gray-200 h-64 overflow-y-auto">
            ${legalBody}
        </div>
        ...
        <form id="consentForm" class="space-y-6">
            ...
            <div class="cf-turnstile" data-sitekey="${turnstileSiteKey}" data-callback="javascriptCallback"></div>

            <div id="errorMsg" class="hidden text-red-600 text-sm font-medium p-3 bg-red-50 rounded-md border border-red-200"></div>
            <div id="successMsg" class="hidden text-green-600 text-sm font-medium p-4 bg-green-50 rounded-md border border-green-200 text-center">
